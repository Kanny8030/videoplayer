...
//$(document).ready(function() {
    function createPlaylistCard(obj, pos) {
        ...
        var container = document.getElementById('playlist-wrapper')
...
mainDiv.onclick = function () {
  ...
  loadVideo(obj.id);
        ...
        function loadVideo(id) {
          ...
          video.src =  "https://player.vimeo.com/video/" + videoPlaySectionData[id - 1].vimeoId;
          
          var views = document.getElementById("views-count")
          views.textContent = videoPlaySectionData[id - 1].views;
         
          var title = document.getElementById("video-title")
          title.textContent = videoPlaySectionData[id - 1].title;

          var desc = document.getElementById("video-description")
          desc.textContent =videoPlaySectionData[id - 1].description;
        }
